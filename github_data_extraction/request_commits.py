...
#  call get api
r = requests.get('https://api.github.com/repos/'+github_user+'/'+github_repo+'/'+'commits?per_page=100', auth=('token', '<your OAuth token>'))
# /Users/evermal/Documents/soen691E/course_project/commits/
