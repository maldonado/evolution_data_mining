...
#  call get api
r = requests.get('https://api.github.com/repos/'+github_user+'/'+github_repo+'/'+'commits?per_page=100', auth=('token', '921b25d22ff228fb5063c671a075efc60c7cfe33'))
f = codecs.open("/Users/evermal/Documents/soen691E/course_project/commits/"+github_repo+"_"+str(counter)+".json", "w", "utf-8")
f.write(r.text)
f.close()
